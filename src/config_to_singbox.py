...
class ConfigToSingbox:
    ...
    def process_configs(self):
        ...
        final_config = {
            ...
            "dns": {
                "servers": [
                    {"type": "https", "server": "@proxyfig", "detour": "🌐 Anonymous Multi", "tag": "dns-remote"},
                    {"type": "udp", "server": "@proxyfig", "server_port": 53, "tag": "dns-direct"},
            ...
            "route": {
                ...
                "default_domain_resolver": {"server": "@proxyfig", "strategy": "prefer_ipv4", "rewrite_ttl": 60},
                "final": "🌐 Anonymous Multi"
            },
            "ntp": {"enabled": True, "server": "@proxyfig", "server_port": 123, "domain_resolver": "dns-direct", "interval": "30m", "write_to_system": False},
            "experimental": {
