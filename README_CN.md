[![Stars](https://img.shields.io/github/stars/4n0nymou3/RMA?style=flat-square)](https://github.com/4n0nymou3/RMA/stargazers)
[![Forks](https://img.shields.io/github/forks/4n0nymou3/RMA?style=flat-square)](https://github.com/4n0nymou3/RMA/network/members)
[![Issues](https://img.shields.io/github/issues/4n0nymou3/RMA?style=flat-square)](https://github.com/4n0nymou3/RMA/issues)
[![License](https://img.shields.io/github/license/4n0nymou3/RMA?style=flat-square)](https://github.com/4n0nymou3/RMA/blob/main/LICENSE)
[![Activity](https://img.shields.io/github/last-commit/4n0nymou3/RMA?style=flat-square)](https://github.com/4n0nymou3/RMA/commits)
...
```
https://raw.githubusercontent.com/4n0nymou3/RMA/refs/heads/main/configs/proxy_configs.txt
```
### Xray 配置（已测试且健康）
通过此 URL 访问那些使用 Xray 核心成功通过实时健康检查的配置：
```
https://raw.githubusercontent.com/4n0nymou3/RMA/refs/heads/main/configs/proxy_configs_tested.txt
```
### Xray 负载均衡配置（已测试）
通过此 URL 访问已经过 Xray 核心测试并针对负载均衡进行了优化的配置，可根据延迟自动选择最佳配置：
```
https://raw.githubusercontent.com/4n0nymou3/RMA/refs/heads/main/configs/xray_loadbalanced_config.json
```
...
```
https://raw.githubusercontent.com/4n0nymou3/RMA/refs/heads/main/configs/singbox_configs_all.json
```
### Sing-box 配置（已测试且健康）
通过此 URL 访问那些使用 Sing-box 核心成功通过实时健康检查的配置：
```
https://raw.githubusercontent.com/4n0nymou3/RMA/refs/heads/main/configs/singbox_configs_tested.json
```
## 频道和 URL 性能
...
### 详细报告
📊 [查看完整交互式仪表盘](https://htmlpreview.github.io/?https://github.com/4n0nymou3/RMA/blob/main/assets/performance_report.html)
...
2. 找到以下行：
   ```markdown
   📊 [查看完整交互式仪表盘](https://htmlpreview.github.io/?https://github.com/USERNAME/RMA/blob/main/assets/performance_report.html)
   ```
...
```bash
# 克隆仓库
git clone https://github.com/4n0nymou3/RMA.git
cd RMA
